...
class CausalSelfAttention(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.attn_mode = config.attn_mode  # You can change this to 'all' or 'local' as needed
        self.local_attn_ctx = config.local_attn_ctx  # Adjust this value as needed
        
        # Create and register the attention mask
        self.register_buffer("mask", get_attn_mask(config.block_size, self.attn_mode, self.local_attn_ctx))
    ...
    def forward(self, x):
        ...
        # Apply the sparse attention mask
